...
public class ShopController : MonoBehaviour
{
    ...
    public void nombreBotonUso(string boton)
    {
        nombreBoton = boton;
        ...
        if (dinero >= precioItem)
            {
                ...
                PlayerPrefs.SetInt("Chapa", index);
                GameObject BuySpain = GameObject.Find(index.ToString());
                BuySpain.SetActive(false);
                GameObject ActiveSpain = GameObject.Find(nombreBoton);
                ActiveSpain.GetComponent<Button>().interactable = true;
